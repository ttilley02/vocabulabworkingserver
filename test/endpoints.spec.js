...
describe("notes Endpoints", function () {
  ...
  before("clean the table", () =>
    db.raw(
      "TRUNCATE vocabulab_users, vocabulab_cards, vocabulab_notes RESTART IDENTITY CASCADE"
    )
  );
    ...
    context("Given there are notes in the database", () => {
      ...
      beforeEach("insert users", () => {
        return db
          ...
          .insert(testUsers)
          .then(() => {
            return db.into("vocabulab_cards").insert(testCards);
          });
      });
        ...
        return db
          ...
          .then(() => {
            return db
              ...
              .insert(testCards)
              .then(() => {
                return db.into("vocabulab_notes").insert(testNotes);
              });
          });
      });
